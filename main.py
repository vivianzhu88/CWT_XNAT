...
parser.add_argument('--data_path', type=str,default='Data', help='use example data path' )
parser.add_argument('--xnat_proj_id', type=str,default='', help='ID of XNAT project that contains data')
parser.add_argument('--use_out_path', action='store_true', default=False, help=' use client destinated path? if mapping to outer_data_path directory')
parser.add_argument('--outer_data_path', type=str,default='Data_v1', help='map external data path to Data_v1 folder')
# parser.add_argument('--outer_data_path', type=str,default='/home/vicky/Research/Deep_Learning/Pytorch/distrubuted/tmp/Data/', help='map external data path to Data_v1 folder')
...
parser.add_argument('--batch_size', type=int, default=16, help='Training batch size') #can change based on comp
